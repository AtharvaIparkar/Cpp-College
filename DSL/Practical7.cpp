...
node *nn = new node;
head = nn;
cout << "Enter Name of president : "; cin >>
nn->name;
...
int p;
cout << "Enter the position where you want to add : "; cin >> p;
...
cn = cn -> next;
cn -> next = header2;
cout << "Lists of Division A and Division B are concatinated! Club has total "
